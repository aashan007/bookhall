...
(function () {
    ...
    var passwordIsComplex = function (password) {
        //  implement password complexity rules here.  There should be similar rule on the server side.
        return true;
    };
    ...
    $(document).delegate("#page-signup", "pagebeforecreate", function () {
        ...
        $btnSubmit.off("tap").on("tap", function () {
            ...
            if (!passwordIsComplex(password)) {
                //  Use error message to explain password rules.
                    ...
                    if (resp.extras.msg) {
                        switch (resp.extras.msg) {
                            ...
                            case BookIt.ApiMessages.COULD_NOT_CREATE_USER:
                                //  Use a friendlier error message below.
